...
/**
  ...
  *
  * @param {object} history - The history instance used by your react router provider (for tracking route changes).
  ...
  */
export const useTracking = (history, blacklisted, sendToCustomService, debug) => {
  useEffect(() => {
    tracker.debug = debug;
